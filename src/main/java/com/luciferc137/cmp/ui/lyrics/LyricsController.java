...
public class LyricsController {
    ...
    @FXML public ImageView coverArtView;
    ...
    @FXML private LyricsColorHandler lyricsColorHandler;
    ...
    public void initialize() {
        ...
        lyricsColorHandler = new LyricsColorHandler(this);
        ...
        if (headerBox != null) {
            headerBox.widthProperty().addListener((
                    obs, oldVal, newVal)
                    -> lyricsColorHandler.refreshBackgroundGradient());
    ...
    public void setMusic(Music music) {
        ...
        // Load cover art
        loadCoverArt(music);
        lyricsColorHandler.updateGradientColor();
